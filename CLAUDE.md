...
Read this first. It is the orientation for a fresh session. The team doc is
`SHARED_CONTEXT.md` (here on `main`); P3's detailed status is `P3_STATUS.md` on
the `person3` branch (`git show person3:P3_STATUS.md`).
